...
@DatasetReader.register("trofi_reader")
class TrofiDatasetReader(DatasetReader):
    """
    Reads a csv file containing the following columns: {"verb", "sentence", "verbIndex","label"}
        1. The verb.
        2. Sentence that includes also a pair of verb and an object.
	3. The index of the verb in the sentence.
	4. Label - 1 if the verb-object pair in the sentence is a metaphore, 0 otherwise
    ...
    def _read(self, file_path):
        ...
        with open(file_path) as f:
            ...
            # line[1] is the sentence
            # line[2] is the index of verb in the sentence
            # line[3] is the label - 0 for non-metaphore, 1 for metaphore
            ...
            for line in raw_lines:
                ...
                yield self.text_to_instance(line[1].strip(),line[2], line[3])
            
            print('TroFi dataset', counter) # print number of lines read from csv file
