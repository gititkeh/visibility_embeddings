...
@DatasetReader.register("mohx_reader")
class MohxDatasetReader(DatasetReader):
    """
    Reads a csv file containing the following columns: {"sentence", "verb", "verbIndex", object, "label"}
	1. Sentence that includes also a pair of verb and an object.
	2. The verb.
	3. The index of the verb in the sentence.
	4. An object
	5. Label - 1 if the verb-object pair in the sentence is a metaphore, 0 otherwise
    ...
    def __init__(self) -> None:
        # we use very simple word tokenizer to split sentence to words - the corpus is already processed
    ...
    def _read(self, file_path):
        ...
        with open(file_path) as f:
            ...
            # line[0] is the sentence 
            # line[2] is the index of verb in the sentence
            # line[4] is the label - 0 for non-metaphore, 1 for metaphore
            ...
            for line in raw_lines:
                ...
                yield self.text_to_instance(line[0].strip(),line[2], line[4])
            
            print('MOH-X dataset', counter) # print number of lines read from csv file
